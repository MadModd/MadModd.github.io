...
function addTodo(strtodo) {
  var strtodo = $("#inTodo").val();
  
  if ((strtodo != "") && (strtodo.length < 32)) {
...
$(".todoList").on("click", ".todoItem .item .fa-check-circle", (event) => {
  ...
  // $(event.target).parents("li").toggleClass("fa-checked-circle");
});
...
// addTodo("Buy milk");
// console.log("Loaded with fresh juice");